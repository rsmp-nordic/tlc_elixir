defmodule Tlc.Logic do
  ...
  This module handles the traffic light logic and runtime logic for a Tlc.Program.Fixed.
  """
  ...
  def update_states(logic) do
    ...
    new_states = Tlc.Program.Fixed.resolve_state(logic.program, logic.cycle_time)
