defmodule Tlc.FixedTime.Logic do
  require Logger
  @moduledoc """
  A module to simulate a fixed-time traffic light program.

  This module handles the traffic light logic and runtime logic for a Tlc.FixedTime.Program.
  """

  defstruct mode: :run,
            program: %Tlc.FixedTime.Program{},
            target_program: nil,
            offset_adjust: 0,
            offset: 0,
            unix_time: nil,
  ...
  def update_states(logic) do
    ...
    new_states = Tlc.FixedTime.Program.resolve_state(logic.program, logic.cycle_time)
