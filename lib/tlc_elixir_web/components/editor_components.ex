defmodule TlcElixirWeb.EditorComponents do
  ...
  def program_button(assigns) do
    ...
    <div class="relative group">
      <div
        class={"px-3 py-2 rounded-md text-gray-200 flex items-center justify-between cursor-pointer transition-colors w-32 #{if @active, do: "bg-purple-700", else: "bg-gray-700 hover:bg-gray-600"}"}
  ...
  def program_edit_form(assigns) do
    ...
    <form phx-change="update_program_form" phx-submit="prevent_submit" class="flex items-center gap-3">
      ...
      <div class="flex items-center">
        ...
        <input
          phx-hook="InputHandler"
          data-field="length"
          type="number"
          id="program-length-input"
          name="program_length"
  ...
  def program_definition_section(assigns) do
    ...
    assigns =
      assign_new(assigns, :program_text, fn ->
    ...
    <div class="mt-4 border-t border-gray-600 pt-4">
      <div class="flex justify-between items-center mb-2">
        ...
        <.pill
          tag="button"
          phx-click="apply_program_definition"
          class={
            if(@json_error || @validation_error,
              do: "bg-gray-500 cursor-not-allowed",
              else: "bg-purple-700 hover:bg-purple-600"
            )
          }
      ...
      <div class="mb-2">
        <textarea
          phx-keyup="update_program_definition"
          phx-debounce="300"
